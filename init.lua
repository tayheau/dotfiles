...
-- 	_, sm.i = string.find(sm.input, "[a-zA-Z0-9- ]*", sm.i)
-- end
--
...
-- local test_sm = {
-- 	i = 1,
-- 	input = "token parsing map"
-- }
--
-- end_string(test_sm)
-- vim.print(test_sm)
-- if test_sm.i == #test_sm.input then vim.print("find new line") end
--
...
--
-- setup_todo_buf_render(8, overing_layout)
